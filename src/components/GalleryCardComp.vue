<template>
  <div class="gallery__card">
    <div class="gallery__img-box">
      <img class="gallery__card_img" :src="card.img" :alt="card.title" />
      <div class="gallery__card_like">
        <svg
          width="36"
          height="35"
          viewBox="0 0 36 35"
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                ...
                result="effect1_dropShadow_8_904"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_dropShadow_8_904"
                result="shape"
              />
            </filter>
          </defs>
    ...
    <div class="gallery__card_info">
      <div class="gallery__card_info_box">
        <h3 class="gallery__card_title">{{ card.title }}</h3>
        <p class="gallery__card_path">{{ card.path }}</p>
      </div>
      <div class="gallery__card_info_link">
        <router-link to="/ProjectsDetailsPage">
          <svg
            width="70"
            height="70"
            viewBox="0 0 70 70"
