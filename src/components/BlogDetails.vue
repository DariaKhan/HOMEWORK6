      ...
      <div class="blog-article__info-box">
        <div v-for="article in articleCases" :key="article.id">
          ...
          <img
            ...
            :src="require('@/assets/img/3-article_picture1.png')"
            alt="blog_image"
          />
        ...
        <img
          ...
          :src="require('@/assets/img/3-article_picture2.png')"
          alt="blog_image"
        />
